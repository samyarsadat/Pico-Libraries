...
#ifndef BRIDGE_EXEC_INTERVAL_MS
#define BRIDGE_EXEC_INTERVAL_MS  200
#endif
#ifndef BRIDGE_EXEC_INTERVAL_LIMIT_MS
#define BRIDGE_EXEC_INTERVAL_LIMIT_MS  (BRIDGE_EXEC_INTERVAL_MS + 10)
#endif
